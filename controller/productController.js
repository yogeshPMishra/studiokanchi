...
exports.getProductsByAttributes = async (req, res, next) =>{
  try {
    ...
    const attributes = await Productattribute.findOne(
        { product_id : req.params.product_id, attribute_name : req.params.attribute_name, attribute_value : req.params.attribute_value }
      );
